...
def algorithm(draw, grid, start, end):
    ...
    h_score = {spot: heuristic(spot.get_pos(), end.get_pos(), 'chebyshev') for row in grid for spot in row}
    ...
    while open_list:
        ...
        for neighbor in neigh_node:
            ...
            if heuristic(neighbor.get_pos(), current_node.get_pos(), 'chebyshev') > 1:
                # Diagonal movement
